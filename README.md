...
- **Écoute sans coupure** : « Écouter la sourate » ou « Écouter d'une traite » (bloc « Passage », du verset X au verset Y) enchaînent les versets sans aucun trou : les fichiers sont téléchargés et décodés à l'avance puis programmés bout à bout (Web Audio, exact à l'échantillon près, vérifié à 0 s d'écart). Le bouton « Répéter » d'un verset, ou « Répéter en boucle » d'un passage, tourne sans coupure jusqu'à « Arrêter » **sans quitter l'écran Récitation** (l'onglet Hifz reste disponible via « Mémoriser (Hifz) »). Une barre en bas indique le verset et le nombre de lectures. À vitesse ≠ 1× (qui conserve la hauteur de la voix), la lecture passe verset par verset et de courtes coupures sont possibles.
