...
export const RECITERS = [
  { id: 'alafasy', name: 'Mishary Rashid Alafasy', country: 'Koweït', style: 'murattal', folder: 'Alafasy_128kbps' },
  { id: 'sudais', name: 'Abdurrahman As-Sudais', country: 'Arabie saoudite', style: 'murattal', folder: 'Abdurrahmaan_As-Sudais_192kbps' },
  { id: 'shuraym', name: 'Saud Ash-Shuraym', country: 'Arabie saoudite', style: 'murattal', folder: 'Saood_ash-Shuraym_128kbps' },
  ...
  { id: 'abdulbasit', name: 'Abdul Basit Abdus-Samad', country: 'Égypte', style: 'murattal', folder: 'Abdul_Basit_Murattal_192kbps' },
  { id: 'minshawy', name: 'Mohamed Siddiq Al-Minshawi', country: 'Égypte', style: 'murattal', folder: 'Minshawy_Murattal_128kbps' },
  { id: 'shaatree', name: 'Abu Bakr Ash-Shatri', country: 'Arabie saoudite', style: 'murattal', folder: 'Abu_Bakr_Ash-Shaatree_128kbps' },
  ...
  { id: 'rifai', name: 'Hani Ar-Rifai', country: 'Arabie saoudite', style: 'murattal', folder: 'Hani_Rifai_192kbps' },
